...
#if defined(__PV_JNI__) || defined(__PV_MOCKS__)

#define PV_API

#elif defined(__PV_PLATFORM_WINDOWS__)
...
#define PV_MOCKABLE(FUNC_NAME) _##FUNC_NAME

#else

#define PV_MOCKABLE(FUNC_NAME) FUNC_NAME
 ...
 */
PV_API int32_t PV_MOCKABLE(pv_sample_rate)(void);
 ...
 */
PV_API const char *PV_MOCKABLE(pv_status_to_string)(pv_status_t status);

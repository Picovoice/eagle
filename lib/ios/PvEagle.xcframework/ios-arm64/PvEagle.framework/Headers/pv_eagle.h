 ...
 */
PV_API pv_status_t PV_MOCKABLE(pv_eagle_profiler_init)(
 ...
 */
PV_API void PV_MOCKABLE(pv_eagle_profiler_delete)(pv_eagle_profiler_t *object);
 ...
 */
PV_API const char *PV_MOCKABLE(pv_eagle_profiler_enroll_feedback_to_string)(pv_eagle_profiler_enroll_feedback_t feedback);
 ...
 * `PV_STATUS_ACTIVATION_THROTTLED`, or `PV_STATUS_ACTIVATION_REFUSED` on failure.
 */
PV_API pv_status_t PV_MOCKABLE(pv_eagle_profiler_enroll)(
        pv_eagle_profiler_t *object,
        const int16_t *pcm,
        int32_t num_samples,
 ...
 */
PV_API pv_status_t PV_MOCKABLE(pv_eagle_profiler_enroll_min_audio_length_samples)(
 ...
 */
PV_API pv_status_t PV_MOCKABLE(pv_eagle_profiler_export)(
        const pv_eagle_profiler_t *object,
 ...
 * @return Status code. Returns `PV_STATUS_INVALID_ARGUMENT` on failure
 */
PV_API pv_status_t PV_MOCKABLE(pv_eagle_profiler_export_size)(
        const pv_eagle_profiler_t *object,
 ...
 * @return status code. Returns `PV_STATUS_INVALID_ARGUMENT` on failure.
 */
PV_API pv_status_t PV_MOCKABLE(pv_eagle_profiler_reset)(pv_eagle_profiler_t *object);
 ...
 * `PV_STATUS_ACTIVATION_THROTTLED`, or `PV_STATUS_ACTIVATION_REFUSED` on failure.
 */
PV_API pv_status_t PV_MOCKABLE(pv_eagle_init)(
        const char *access_key,
        const char *model_path,
 ...
 */
PV_API void PV_MOCKABLE(pv_eagle_delete)(pv_eagle_t *object);
 ...
 * `PV_STATUS_ACTIVATION_THROTTLED`, or `PV_STATUS_ACTIVATION_REFUSED` on failure.
 */
PV_API pv_status_t PV_MOCKABLE(pv_eagle_process)(
        pv_eagle_t *object,
        const int16_t *pcm,
        float *scores);
 ...
 * @return Status code. Returns `PV_STATUS_INVALID_ARGUMENT` on failure.
 */
PV_API pv_status_t PV_MOCKABLE(pv_eagle_reset)(pv_eagle_t *object);
 ...
 * @return Frame length.
 */
PV_API int32_t PV_MOCKABLE(pv_eagle_frame_length)(void);
 ...
 * @return Version.
 */
PV_API const char *PV_MOCKABLE(pv_eagle_version)(void);
